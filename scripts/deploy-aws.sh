...
INSTANCE_TYPE="${UNIKERNEL_EC2_TYPE:-t3.micro}"
BUCKET="${UNIKERNEL_S3_BUCKET:-${NAME}-images-$(aws sts get-caller-identity --query Account --output text 2>/dev/null || echo 'unknown')}"
