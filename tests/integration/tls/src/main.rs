...
fn init() {
    ...
    // immediately.
    {
        ...
        let server_priv: [u8; 32] = [
            0xb1, 0x58, 0x0e, 0xea, 0xdf, 0x6d, 0xd5, 0x89, 0xb8, 0xef, 0x4f, 0x2d, 0x56, 0x52,
            0x57, 0x8c, 0xc8, 0x10, 0xe9, 0x98, 0x01, 0x91, 0xec, 0x8d, 0x05, 0x83, 0x08, 0xce,
            0xa2, 0x16, 0xa2, 0x1e,
        ];
        ...
        let secrets = sched.enter_handshake(&shared, &expected_transcript_after_sh);
