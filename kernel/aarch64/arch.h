...
static inline uint16_t virtio_read16(uint64_t base) { return mmio_read16(base); }
static inline uint32_t virtio_read32(uint64_t base) { return mmio_read32(base); }
static inline void virtio_write8 (uint64_t base, uint8_t  v) { mmio_write8 (base, v); }
static inline void virtio_write16(uint64_t base, uint16_t v) { mmio_write16(base, v); }
static inline void virtio_write32(uint64_t base, uint32_t v) { mmio_write32(base, v); }
