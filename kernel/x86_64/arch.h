...
// kernel/x86_64/arch.h — Architecture-specific helpers for x86_64
//
// Included via the kernel/arch.h dispatcher. Provides the arch:: namespace
// with x86_64 primitives: port I/O, interrupt control, MSRs, TLB management,
// control registers, descriptor table loading, virtio register I/O, and
// memory barriers.
