...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn mm_init(info: *const BootInfo) {
    let info = &*info;
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn mm_alloc_frame() -> u64 {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn mm_free_frame(addr: u64) {
    let frame = addr / PAGE_SIZE;
    if frame >= TOTAL_FRAMES {
        return;
    }
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn mm_kmalloc(size: usize) -> *mut u8 {
    if size == 0 {
        return ptr::null_mut();
    }
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn mm_kfree(ptr: *mut u8) {
    if ptr.is_null() {
        return;
    }
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn mm_get_total_memory() -> usize {
    TOTAL_MEMORY_BYTES as usize
}

#[unsafe(no_mangle)]
pub unsafe extern "C" fn mm_get_free_memory() -> usize {
    ((TOTAL_FRAMES - USED_FRAMES) * PAGE_SIZE) as usize
}

#[unsafe(no_mangle)]
pub unsafe extern "C" fn mm_phys_to_virt(phys: u64) -> *mut u8 {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn mm_virt_to_phys(virt: *const u8) -> u64 {
    #[cfg(target_arch = "aarch64")]
    {
        virt as u64
    }
