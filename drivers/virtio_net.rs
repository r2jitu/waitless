...
pub(crate) static mut NET_TRANSPORT: Transport = Transport::None;
pub(crate) static mut NET_RX_QUEUE: Virtqueue = Virtqueue::ZERO;
pub(crate) static mut NET_TX_QUEUE: Virtqueue = Virtqueue::ZERO;
