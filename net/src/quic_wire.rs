...
// Stays no_std in production. Host tests need std for the
// `panic = "unwind"` libtest harness, so toggle via `feature = "std"`
// like the other pure-protocol crates in //net.
